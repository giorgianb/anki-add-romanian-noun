...
class RomanianNounWindow(QWidget):
    __model_name = u"Romanian Noun Conjugation"
    def __init__(self, main_window, collection):
        super(RomanianNounWindow, self).__init__()
    ...
    def __init_gui(self):
        ...
        self.__forms = {}
        for form in RomanianNoun.get_forms():
            if form == "Infinitive":
                continue
            ...
            if RomanianNoun.is_personal_form(form):
        ...
        self.setWindowTitle("Add Romanian Noun")
        self.show()

    def __on_search(self):
        verb = RomanianNoun(self.__verb_text.text())
...
def run_add_romanian_verb_plugin():
    global __window
    __window = RomanianNounWindow(mw, mw.col);
